...
{
    /// <summary>
    /// Drops the ASP.NET Core Identity tables. Accounts and credentials now live in
    /// Keycloak; the domain <c>users</c> table keeps pointing at them through
    /// <c>external_id</c>, which is the Keycloak user id.
    /// </summary>
    /// <inheritdoc />
    public partial class RemoveAspNetCoreIdentityTables : Migration
    {
        /// <inheritdoc />
